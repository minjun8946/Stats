...
class PlayerDetailActivity : BaseActivity<ActivityPlayerDetailBinding,BaseViewModel>() {

    override val viewModel : PlayerDetailViewModel by viewModel()
    override val layoutResID: Int = R.layout.activity_player_detail
    ...
    private fun getPlayerSeasonEvent(basicData: BasicModel){
        viewModel.getPlayerSeasonEvent.observe(this,{
            if(it >1980) viewModel.getPlayerSeasonStats(PlayerSeasonIdModel(it,basicData.personId))
        })
    }
